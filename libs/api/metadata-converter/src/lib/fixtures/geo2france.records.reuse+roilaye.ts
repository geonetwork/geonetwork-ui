...
export const GEO2FRANCE_REUSE_ROILAYE_RECORD: ReuseRecord = {
    ...
    keywords: [
        {
            thesaurus: {
                ...
                url: new URL('http://geo.compiegnois.fr/geonetwork/srv/fre/thesaurus.download?ref=external.theme.inspire-theme'),
            },
        ...
        },
        {
            thesaurus: {
                ...
                url: new URL('http://geo.compiegnois.fr/geonetwork/srv/en/thesaurus.download?ref=external.theme.gemet'),
            },
        ...
        { label: 'ortho', type: 'theme', translations: {} },
        {
            thesaurus: {
                ...
                url: new URL('http://geo.compiegnois.fr/geonetwork/srv/en/thesaurus.download?ref=external.place.GeoCompiegnois'),
            },
    ...
    overviews: [
        {
            url: new URL('https://geo.compiegnois.fr/geonetwork/srv/api/records/982b6e7d-61f5-43b3-983d-ebae8bc3892d/attachments/Saint-Etienne-Roilaye_ortho_2021.jpg'),
        },
    ],
    spatialExtents: [
    ...
    onlineResources: [
        {
            type: 'link',
            url: new URL('http://geo.compiegnois.fr/documents/cartotheque/Saint-Etienne-Roilaye_ortho_2021.jpg'),
