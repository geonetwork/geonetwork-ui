...
@Component({
  template: `<gn-ui-resource-wrapper [ngStyle]="{ width: width + 'px' }">
    <div *ngFor="let block of blocks" style="width: 50px"></div>
  </gn-ui-resourceWrapper>`,
})
