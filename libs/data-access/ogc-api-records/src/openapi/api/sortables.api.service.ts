...
import { SortableApiModel } from '../model/models'
...
export class SortablesApiService {
  ...
  ): Observable<Array<SortableApiModel>>
  public getSortables(
    collectionId: string,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/html' }
  ): Observable<HttpResponse<Array<SortableApiModel>>>
  public getSortables(
    collectionId: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json' | 'text/html' }
  ): Observable<HttpEvent<Array<SortableApiModel>>>
  public getSortables(
    collectionId: string,
    observe: any = 'body',
    ...
    if (collectionId === null || collectionId === undefined) {
      throw new Error(
        'Required parameter collectionId was null or undefined when calling getSortables.'
      )
    }
    ...
    return this.httpClient.get<Array<SortableApiModel>>(
