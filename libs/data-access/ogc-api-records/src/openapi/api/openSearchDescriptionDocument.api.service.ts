...
export class OpenSearchDescriptionDocumentApiService {
   ...
   */
  public getOpenSearchDescriptionDocument(
    collectionId: string,
    observe?: 'body',
  ...
  public getOpenSearchDescriptionDocument(
    ...
    if (collectionId === null || collectionId === undefined) {
      throw new Error(
        'Required parameter collectionId was null or undefined when calling getOpenSearchDescriptionDocument.'
      )
    }
