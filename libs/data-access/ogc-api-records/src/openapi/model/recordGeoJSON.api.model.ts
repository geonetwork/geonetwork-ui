 ...
 */
import { ConformsToApiModel } from './conformsTo.api.model'
import { GeometryGeoJSONApiModel } from './geometryGeoJSON.api.model'
import { LinkApiModel } from './link.api.model'

export interface RecordGeoJSONApiModel {
  /**
   * A unique identifier of the catalogue record.
   */
  id: string
  conformsTo?: ConformsToApiModel
  type: RecordGeoJSONApiModel.TypeEnum
  geometry: GeometryGeoJSONApiModel
...
export namespace RecordGeoJSONApiModel {
