...
export interface GeometrycollectionGeoJSONApiModel {
  type: GeometrycollectionGeoJSONApiModel.TypeEnum
  geometries: Array<GeometryGeoJSONApiModel>
}
export namespace GeometrycollectionGeoJSONApiModel {
