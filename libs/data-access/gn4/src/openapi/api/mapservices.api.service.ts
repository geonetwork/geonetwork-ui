...
import { MapServiceApiModel } from '../model/models.js'
...
export class MapservicesApiService {
  ...
  public getMapservices(
    ...
    return this.httpClient.get<Array<MapServiceApiModel>>(
      `${this.configuration.basePath}/mapservices`,
      {
