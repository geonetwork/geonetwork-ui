...
export class MapViewComponent implements AfterViewInit {
  ...
  selectedLinkIndex$ = new BehaviorSubject<{ linkIndex: number; styleIndex?: number }>({ linkIndex: 0 })
  ...
  getLayerFromLink(link: DatasetOnlineResource, style?: { href: string; name: string }): Observable<MapContextLayer> {
