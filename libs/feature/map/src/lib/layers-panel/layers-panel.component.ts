...
import { AddLayerFromOgcApiComponent } from '../add-layer-from-ogc-api/add-layer-from-ogc-api.component.js'
import { AddLayerFromWfsComponent } from '../add-layer-from-wfs/add-layer-from-wfs.component.js'
import { AddLayerFromWmsComponent } from '../add-layer-from-wms/add-layer-from-wms.component.js'
import { AddLayerFromCatalogComponent } from '../add-layer-from-catalog/add-layer-from-catalog.component.js'
import { AddLayerFromFileComponent } from '../add-layer-from-file/add-layer-from-file.component.js'
