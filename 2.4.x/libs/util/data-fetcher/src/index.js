...
exports.GeojsonReader = exports.BaseFileReader = exports.BaseReader = exports.getJsonDataItemsProxy = exports.FetchError = exports.SupportedTypes = void 0;
...
var base_file_1 = require("./lib/readers/base-file");
Object.defineProperty(exports, "BaseFileReader", { enumerable: true, get: function () { return base_file_1.BaseFileReader; } });
var geojson_1 = require("./lib/readers/geojson");
Object.defineProperty(exports, "GeojsonReader", { enumerable: true, get: function () { return geojson_1.GeojsonReader; } });
