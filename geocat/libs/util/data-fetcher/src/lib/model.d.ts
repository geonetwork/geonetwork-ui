...
export declare class FetchError {
    message: any;
    httpStatus: number;
    isCrossOriginOrNetworkRelated: boolean;
    parsingFailed: boolean;
    contentTypeError: boolean;
    constructor(message: any, httpStatus?: number, isCrossOriginOrNetworkRelated?: boolean, parsingFailed?: boolean, contentTypeError?: boolean);
...
export type SupportedMimeType = typeof CsvMimeTypes[number] | typeof JsonMimeTypes[number] | typeof GeoJsonMimeTypes[number] | typeof ExcelMimeTypes[number];
