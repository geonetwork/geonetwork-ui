describe('Multilingual panel', () => {
  ...
  describe('Switching default language', () => {
    const multilingualRecord = 'e27e7006-fdf9-4004-b6c5-af2a5a5c025c'
    before(() => {
      cy.login('admin', 'admin', false)
      ...
      cy.get('gn-ui-generic-keywords')
        .find('gn-ui-badge')
        .first()
        .find('span')
        .should('have.text', 'Leitungskataster ')
    ...
    it('should display the translated fields in the right language', () => {
      cy.get('gn-ui-generic-keywords')
        ...
        .first()
        .find('span')
        .should('have.text', 'cadastre des conduites ')
    })
  })
})
