...
exports.ES_FIXTURE_FULL_RESPONSE = exports.hitsOnly = void 0;
const freeze_1 = require("../../utils/freeze");
const hitsOnly = () => (0, freeze_1.deepFreeze)({
    hits: {
        max_score: 1,
        hits: [
            {
            ...
            },
            {
                ...
                _source: {
                    ...
                    resourceTitleObject: {
                        default: 'Urban Waste Water Treatment Directive, Sensitive areas - rivers reported under UWWTD data call 2015, Nov. 2017',
                        langeng: 'Urban Waste Water Treatment Directive, Sensitive areas - rivers reported under UWWTD data call 2015, Nov. 2017',
                    },
                    logo: '/images/logos/e6826118-7280-4638-b1f9-d898e9efe281.png',
                    id: '12442',
...
exports.hitsOnly = hitsOnly;
const ES_FIXTURE_FULL_RESPONSE = () => (0, freeze_1.deepFreeze)({
    took: 1,
    timed_out: false,
        ...
        hits: [
            {
                ...
                _source: {
                    ...
                    tag: [
                        ...
                        {
                            default: "/Activités humaines/Réseaux d'observation et de surveillance du littoral",
                            langfre: "/Activités humaines/Réseaux d'observation et de surveillance du littoral",
                        },
                        {
                        ...
                        {
                            default: '/Biogéochimie marine/Eléments chimiques et contaminants',
                            langfre: '/Biogéochimie marine/Eléments chimiques et contaminants',
                        },
                        {
                    ...
                    lineageObject: {
                        default: 'Les données sont bancarisées dans la base de données Quadrige.',
                        langfre: 'Les données sont bancarisées dans la base de données Quadrige.',
                    },
                    format: [''],
                    linkUrl: [
                    ...
                    link: [
                        ...
                        },
                        {
                            ...
                            description: 'Manuel pour l’utilisation des données REPHY. Informations destinées à améliorer la compréhension des fichiers de données REPHY mis à disposition des scientifiques et du public. ODE/VIGIES/17-15. Ifremer, ODE/VIGIES, Coordination REPHY & Cellule Quadrige (2017).',
                            function: '',
                            applicationProfile: '',
                            group: 1,
                        },
                    ...
                    linkUrlProtocolWWWLINK10httplink: 'https://wwz.ifremer.fr/envlit/Surveillance-du-littoral',
                    ...
                    linkUrlProtocolWWWLINK10httpmetadataURL: 'https://doi.org/10.12770/cf5048f6-5bbf-4e44-ba74-e6f429af51ea',
                    ...
                    MD_LegalConstraintsOtherConstraintsObject: [
                        ...
                        {
                            default: 'Licence Ouverte version 2.0  https://www.etalab.gouv.fr/wp-content/uploads/2017/04/ETALAB-Licence-Ouverte-v2.0.pdf',
                            langfre: 'Licence Ouverte version 2.0  https://www.etalab.gouv.fr/wp-content/uploads/2017/04/ETALAB-Licence-Ouverte-v2.0.pdf',
                        },
                    ],
                    licenseObject: [
                        {
...
exports.ES_FIXTURE_FULL_RESPONSE = ES_FIXTURE_FULL_RESPONSE;
//# sourceMappingURL=metadata.fixtures.js.map